...
public class SpeakerDuelMode : BaseGameMode
{
    ...
    Dictionary<BaseSpeaker, BasePlayerUI> characterUI = new();
    ...
    {
        gameEcho = FindObjectsByType<BaseEcho>(FindObjectsSortMode.InstanceID)[0];
        
        gameEcho.InitProjectile(speakerList);
    ...
    public override void RemoveCharacter(BaseSpeaker character)
    {
